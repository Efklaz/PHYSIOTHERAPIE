    ...
    <section id="physiotherapie" className="gap-16 bg-gray-20 py-10 md:h-full md:pb-0">
      ...
      >
        ...
        <div className="z-10 mt-32 md:basis-3/5 py-10">
          ...
          {/* ACTIONS */}
          <motion.div
            className="mt-8 flex flex-wrap items-center gap-8 justify-start"
            initial="hidden"
            whileInView="visible"
            viewport={{ once: true, amount: 0.5 }}
          ...
          >
            ...
            <AnchorLink
              className="text-md px-10 py-2 font-bold text-secondary-500 underline hover:text-primary-500"
